...
| 2026-01-17 | Assumi que testes falhando = deps faltando. Na verdade, LTE usa Marker (nao pytesseract/pdf2image/anthropic) | **VER CLAUDE.md DO MODULO antes de rodar testes** - codigo legado tem imports obsoletos |
