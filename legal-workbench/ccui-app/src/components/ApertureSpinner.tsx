...
// Paleta adaptada ao design system Claude Terroso do ccui-app
const DEFAULT_PALETTE = {
  red: 'rgb(200, 120, 74)',   // --accent (#c8784a)
  light: 'rgb(74, 53, 32)',   // --border-mid (#4a3520)
  dark: 'rgb(41, 28, 21)',    // --bg-cards (#291c15)
}
...
/**
 * Spinner com animacao de apertura -- 4 formas girando e morphando (quadrado -> circulo).
 * Versao completa com connector lines e centro hub.
 */
...
/**
 * Variante compacta para uso inline (ex: indicador de processamento no chat).
 * Mesma logica mas sem connector lines, sem screw heads, sem center hub.
 * Apenas as 4 formas girando e morphando.
 */
export const ApertureSpinnerMini: React.FC<ApertureSpinnerProps> = ({
  size = 20,
  palette = DEFAULT_PALETTE,
}) => {
  const canvasRef = useRef<HTMLCanvasElement>(null)
