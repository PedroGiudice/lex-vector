...
class SystemPatterns:
    ...
    ESAJ = [
        CleaningPattern(
            ...
            regex=re.compile(r"c[óo]digo\s+do\s+documento:\s*[A-Z0-9]{8,20}", re.IGNORECASE),
            category="esaj",
        ),
        CleaningPattern(
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"resolu[çc][ãa]o\s+n?[º°]?\s*552/11", re.IGNORECASE),
            category="esaj",
        ),
        CleaningPattern(
            description="Marca d'água ESAJ",
            regex=re.compile(r"\[marca\s+d.?[áa]gua:?\s*esaj\]", re.IGNORECASE),
            category="esaj",
        ),
    ]
    ...
    EPROC = [
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"byterange\s*\[\s*\d+\s+\d+\s+\d+\s+\d+\s*\]", re.IGNORECASE),
            category="eproc",
        ),
    ]
    ...
    PROJUDI = [
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"projudi\s+-\s+vers[ãa]o\s+\d+\.\d+(\.\d+)?", re.IGNORECASE),
            category="projudi",
        ),
        CleaningPattern(
    ...
    STF = [
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"assinatura\s+digital\s+pkcs\s*[#]?\s*7", re.IGNORECASE),
            category="stf",
        ),
        CleaningPattern(
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"resolu[çc][ãa]o\s+stf\s+n?[º°]?\s*693/2020", re.IGNORECASE),
            category="stf",
        ),
        CleaningPattern(
    ...
    STJ = [
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"valide\s+este\s+documento\s+via\s+qr\s+code", re.IGNORECASE),
            category="stj",
        ),
        CleaningPattern(
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"\[logo\s+institucional\s+stj\]", re.IGNORECASE),
            category="stj",
        ),
    ]
    ...
    GENERIC_JUDICIAL = [
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"certificado\s+digital:?\s*[^\n]{5,100}", re.IGNORECASE),
            category="generic",
        ),
        CleaningPattern(
    ...
    UNIVERSAL = [
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"emissor:?\s*cn\s*=\s*ac\s+[^\n]{10,80}", re.IGNORECASE),
            category="universal",
        ),
        CleaningPattern(
        ...
        CleaningPattern(
            ...
            regex=re.compile(r"assinatura\s+qualificada\s+icp-brasil", re.IGNORECASE),
            category="universal",
        ),
        CleaningPattern(
